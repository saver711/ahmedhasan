...
///
export const NotFound = ({ title, setIsMounted }) => {
  /////////// VARIABLES
  ///
  ...
  const Canyon = () => {
    ...
    return (
      ...
      >
        ...
        <path
          style={{ transform: `translate(${p3.x}px,${p3.y}px)` }}
          className={classes.fill_gray_900}
        ...
        />
        <g
          style={{ transform: `translate(${p1.x}px,${p1.y}px)`, opacity: 0.2 }}
        >
        ...
        <g
          style={{ transform: `translate(${p2.x}px,${p2.y}px)`, opacity: 0.4 }}
        >
        ...
        <g
          style={{ transform: `translate(${p3.x}px,${p3.y}px)`, opacity: 0.7 }}
        >
    ...
    <>
      ...
      <div className={`${classes.app}`}>
        <div className={`${classes.text_container}`}>
          <h1>Not Found</h1>
          <p>Did you get lost in a sandstorm?!😃</p>
          <p>
            You can <Link to='/'>go back home</Link>.
          </p>
        </div>
        <Canyon />
      </div>
